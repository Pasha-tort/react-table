...
export declare class AppService {
    constructor();
    setCardsAfterDND({ srcCellId, srcElId, finalCellId, numberCardDrop, positionDrop, }: TypeBord.setCardsAfterDND.Request): TypeBord.setCardsAfterDND.Response;
    ...
    setOneCard({ dataCard, }: TypeBord.setOneCard.Request): TypeBord.setOneCard.Response;
